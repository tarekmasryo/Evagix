...
def _cmd_agents(root: Path, output_format: str) -> int:
...
def _cmd_mcp(root: Path, output_format: str) -> int:
    root = _normalize_existing_root(root)
